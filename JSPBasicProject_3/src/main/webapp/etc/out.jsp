	...
	주요 메소드
	    ...
	    http://localhost/JSPBasicProject_3/etc/out.jsp
	                     ...
	                     =================
	                         ContextPath
	    추가정보
	    setAttribute() => request에 데이터추가해서 넘겨주는 경우
	    getAtrribute() => 추가된 데이터 읽기
	    ==========================
	    
	    Model 1
	    JSP <=> JSP (JSP 와 JSP 연결)
...
<body>
  ...
  1.전체버퍼의 크기:<%= out.getBufferSize() %> <%-- 8*1024 (default)--%>
  <br>

...
<%--
	   ...
	   => Selector (잘 알고 있어야 한다)
	      = 기본
	        => 태그명
	           ...
	           * 많이 사용되지 않는 이유 => 태그가 많다 --> 그래서 구분자 필요
	        ===============구분자================
	        => ID명 => 중복이 없는 구분자
	           #ID명{
	             속성:값
	    ...
	    반응 선택자 : ID명,class명,태그명:hover
	                           =========== mouseover
	    구조 선택자 : nth-child(수열)
	               nth-child(2n) ==> n은 0부터 시작 => 0 2 4 6 ...
	               nth-child(2n+1) ==> n=0부터 시작  => 1 3 5 7 ...
	    문자 선택자 : ::after , ::before
	    ============================================
	...
	# 192page => 위치속성
	  ...
	  --------------------------
	  relative : 상대 태그 좌표 이용 (옆에 있는 태그를 기준점으로 잡는다)
	  --------------------------
	  absolute : 절대 좌표 
	  --------------------------
	  fixed : 고정 => 상세보기

...
//		if(cookies!=null)
//		{
//			for(int i=cookies.length-1;i>=0;i--) // 가장 최근 본 걸 앞으로 빼는 작업
//			{
//				if(cookies[i].getName().startsWith("food")) // getName() -> "food_"+fno (키) 읽기
//				{
//					String fno=cookies[i].getValue(); // getValue() -> Cookie 두번째 매개변수인 fno 읽기
//					FoodVO vo=dao.foodDetailData(Integer.parseInt(fno));
//					cList.add(vo); // cList 만 출력해주면 Cookie들 출력 가능
//				}
//			}
//		}
		// 블록 나누기 **
...
//				out.write("<img src="+vo.getPoster()+" style=\"width:100px;height:100px\">&nbsp;");
//				out.write("</a>");
//			}
//		}
//		else
//		{
//			out.write("<h3>방문한 기록이 없습니다</h3>"); // cList=0 -> 쿠키 X 
//		}
		out.write("</div>");
		out.write("</div>");
		out.write("</body>");

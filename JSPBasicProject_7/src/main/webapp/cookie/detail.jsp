...
<%
	...
	// <%= vo.getPoster()  ==> ${vo.poster} => getPoster()호출
			// 770d5b30571e577ec2ea2a6789c3cbc5
%>
<!DOCTYPE html>
<html>
<head>
  ...
  <div class="container">
   <div class="col-sm-7"> <!-- float:left -->
     <table class="table">
      ...
      <tr>
        <td width=15%>주소</td>
        <td width=55%>${vo.address }</td> <!-- getAddress 호출 -->
      </tr>
      <tr>
        <td width=15%>전화</td>
   ...
   <div class="col-sm-5"> <!-- 화면 = 같은 container 안에서 가로로 12등분 -->
...
<script type="text/javascript" src="//dapi.kakao.com/v2/maps/sdk.js?appkey=770d5b30571e577ec2ea2a6789c3cbc5&libraries=services"></script>
<script>

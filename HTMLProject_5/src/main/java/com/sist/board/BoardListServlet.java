...
public class BoardListServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		*/
		...
		// BoardListServlet?page=1 => GET 방식 (? 뒤에 데이터가 붙으면 GET 방식)
		...
		if(page==null)
			page="1"; // 이거 안하면 오류 발생(사용자가 페이지 입력값 안주면 디폴트 1페이지)
		...
		*/
		...
		for(BoardVO vo:list)
		{
			...
			// 제목 클릭하면 해당 글 상세보기로 넘어가야하니 링크 걸어준다
		...
		out.println("<select name=fs>"); // 이름/제목/내용 고르는 
